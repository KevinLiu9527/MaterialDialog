package com.kevin.materialdialog.dialog;
...
import com.kevin.materialdialog.R;

/**
 * 项目名称：MaterialDialog
 * 创建人：KevinLiu   E-mail:KevinLiu9527@163.com
 * 创建时间：2017/7/18 16:04
 * 描述：Material Dialog风格
 */
public class UIAlertDialog {
    ...
    private UIAlertDialog.Builder mBuilder;
    private View mView;
    ...
    public UIAlertDialog setView(View view) {
        mView = view;
        if (mBuilder != null) {
    ...
    public UIAlertDialog setContentView(View view) {
     ...
     */
    public UIAlertDialog setContentView(int layoutResId) {
    ...
    public UIAlertDialog setBackground(Drawable drawable) {
    ...
    public UIAlertDialog setBackgroundResource(int resId) {
    ...
    public UIAlertDialog setTitle(int resId) {
        mTitleResId = resId;
        if (mBuilder != null) {
    ...
    public UIAlertDialog setTitle(CharSequence title) {
        mTitle = title;
        if (mBuilder != null) {
    ...
    public UIAlertDialog setMessage(int resId) {
        mMessageResId = resId;
        if (mBuilder != null) {
    ...
    public UIAlertDialog setMessage(CharSequence message) {
        mMessage = message;
        if (mBuilder != null) {
    ...
    public UIAlertDialog setPositiveButton(int resId, final View.OnClickListener listener) {
        this.pId = resId;
    ...
    public UIAlertDialog setPositiveButton(String text, final View.OnClickListener listener) {
        this.pText = text;
        this.pListener = listener;
        return this;
    }
    ...
    public UIAlertDialog setNegativeButton(int resId, final View.OnClickListener listener) {
        this.nId = resId;
    ...
    public UIAlertDialog setNegativeButton(String text, final View.OnClickListener listener) {
        this.nText = text;
        this.nListener = listener;
        return this;
    }
     ...
     */
    public UIAlertDialog setCanceledOnTouchOutside(boolean cancel) {
        this.mCancel = cancel;
        if (mBuilder != null) {
    ...
    public UIAlertDialog setOnDismissListener(DialogInterface.OnDismissListener onDismissListener) {
    ...
    private class Builder {
        ...
        /**
         * 设置自定义视图资源作为对话框的内容。资源将被膨胀成一个滚动视图。
         */
