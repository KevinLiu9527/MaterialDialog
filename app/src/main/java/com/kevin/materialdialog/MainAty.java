package com.kevin.materialdialog;

import android.support.v7.app.AppCompatActivity;
import android.os.Bundle;

import com.kevin.materialdialog.dialog.UIAlertDialog;
...
public class MainAty extends AppCompatActivity {
    ...
    public void init(View v) {
        mMaterialDialog = new UIAlertDialog(this);
            ...
            mMaterialDialog.setTitle("MaterialDialog")
                    ...
                    .setPositiveButton("OK", new View.OnClickListener() {
                        @Override public void onClick(View v) {
                            ...
                            Toast.makeText(MainAty.this, "Ok",
    ...
    public void setView(View v) {
        switch (v.getId()) {
            ...
            case R.id.button_set_contentView: {
                ...
                final UIAlertDialog alert = new UIAlertDialog(this).setTitle(
            ...
            case R.id.button_set_notitile: {
                final UIAlertDialog materialDialog = new UIAlertDialog(this);
